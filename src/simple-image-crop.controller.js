export default function cropModalController($scope, image, $uibModalInstance, type){
  ...
  $scope.type = type || 'circle';

}

cropModalController.$inject = ['$scope', 'image', '$uibModalInstance', 'type'];
